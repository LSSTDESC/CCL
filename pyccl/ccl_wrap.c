...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"rho_x", _wrap_rho_x, METH_VARARGS, (char *)"rho_x(cosmology cosmo, double a, ccl_rho_x_label label, int * status) -> double"},
	 ...
	 { (char *)"rho_x_vec", _wrap_rho_x_vec, METH_VARARGS, (char *)"rho_x_vec(cosmology cosmo, int label, double * a, double * output, int * status)"},
