...
SWIGINTERN PyObject *baryons_bcm_swigconstant(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *module;
  PyObject *d;
  if (!PyArg_ParseTuple(args,(char*)"O:swigconstant", &module)) return NULL;
  d = PyModule_GetDict(module);
  if (!d) return NULL;
  SWIG_Python_SetConstant(d, "baryons_bcm",SWIG_From_int((int)(ccl_baryons_bcm)));
  return SWIG_Py_Void();
}
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"baryons_bcm_swigconstant", baryons_bcm_swigconstant, METH_VARARGS, NULL},
