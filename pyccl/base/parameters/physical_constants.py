...
class PhysicalConstants(Parameters, instance=lib.cvar.constants, frozen=True):
    ...
    T_CMB: Real = 2.725  # TODO: Remove for CCLv3.
    ...
    T_NCDM: Real = 0.71611  # TODO> Remove for CCLv3.
