...
_PK_ALIAS = {
    ...
    'b2:b2': 'b2:b2', 'b2:bs': 'b2:bs',
    'b2:bk2': 'zero', 'b2:c1': 'b2:m', 'b2:c2': 'b2:c2',
    'b2:cdelta': 'b2:cdelta','b3nl:c1': 'b3nl:m','bs:bs': 'bs:bs',
    'bs:bk2': 'zero', 'c1:bs': 'm:bs', 'bs:c2': 'bs:c2',
    'bs:cdelta': 'bs:cdelta', 'bk2:bk2': 'zero', 'c1:bk2': 'm:bk2',
...
class EulerianPTCalculator(CCLAutoRepr):
    ...
    def update_ingredients(self, cosmo):
        ...
        if self.with_IA:
            ...
            self.ia_ctbias = self.pt.IA_ctbias(**kw)
            reshape_fastpt(self.ia_ctbias)
            self.ia_d2 = self.pt.IA_d2(**kw)
            reshape_fastpt(self.ia_d2)
    ...
    def _get_pgi(self, trg, tri):
        ...
        tijsij, tijdsij, tij2sij, tijtij = self.ia_ct
        gb2tij, s2tij = self.ia_ctbias
        gb2sij, gb2dsij, gb2sij2 = self.ia_d2
        s2sij, s2dsij, s2sij2= self.ia_s2
    ...
    def get_pk2d_template(self, kind, *, extrap_order_lok=1,
        ...
        match pk_name:
            ...
            case 'b2:c2':
                pk = 0.5*self._g4T * self.ia_d2[2]
            case 'b2:cdelta':
                pk = 0.5*self._g4T * self.ia_d2[1]
            case 'bs:cdelta':
                pk = 0.5*self._g4T * self.ia_s2[1]
            case 'bs:c2':
                pk = 0.5*self._g4T * self.ia_s2[2]
            case 'zero':
