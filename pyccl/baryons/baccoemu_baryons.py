...
class BaccoemuBaryons(Baryons):
    ...
    def update_parameters(self, log10_M_c=None, log10_eta=None, log10_beta=None, log10_M1_z0_cen=None, 
                          log10_theta_out=None, log10_theta_inn=None, log10_M_inn=None):
