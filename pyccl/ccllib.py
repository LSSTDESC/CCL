...
def sigmaV(cosmo, R, status):
    """sigmaV(cosmology cosmo, double R, int * status) -> double"""
    return _ccllib.sigmaV(cosmo, R, status)
...
def u_nfw_c(cosmo, c, halomass, k, a, status):
    """u_nfw_c(cosmology cosmo, double c, double halomass, double k, double a, int * status) -> double"""
    return _ccllib.u_nfw_c(cosmo, c, halomass, k, a, status)

def nu(cosmo, halomass, a, status):
    """nu(cosmology cosmo, double halomass, double a, int * status) -> double"""
    return _ccllib.nu(cosmo, halomass, a, status)

def massfunc_st(nu):
    """massfunc_st(double nu) -> double"""
    return _ccllib.massfunc_st(nu)

def I02(cosmo, k, a, status):
    """I02(cosmology cosmo, double k, double a, int * status) -> double"""
    return _ccllib.I02(cosmo, k, a, status)
...
def delta_c():
    """delta_c() -> double"""
    return _ccllib.delta_c()

def Delta_v():
    """Delta_v() -> double"""
    return _ccllib.Delta_v()

def r_delta(cosmo, halomass, a, status):
    """r_delta(cosmology cosmo, double halomass, double a, int * status) -> double"""
    return _ccllib.r_delta(cosmo, halomass, a, status)

def r_Lagrangian(cosmo, halomass, a, status):
    """r_Lagrangian(cosmology cosmo, double halomass, double a, int * status) -> double"""
    return _ccllib.r_Lagrangian(cosmo, halomass, a, status)
...
def inner_I02(logmass, params):
    """inner_I02(double logmass, void * params) -> double"""
    return _ccllib.inner_I02(logmass, params)

def p_1h_vec(cosmo, k, a, output, status):
    """p_1h_vec(cosmology cosmo, double * k, double a, double * output, int * status)"""
    return _ccllib.p_1h_vec(cosmo, k, a, output, status)
