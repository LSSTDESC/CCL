...
rho_crit_label = _ccllib.rho_crit_label
rho_crit_comoving_label = _ccllib.rho_crit_comoving_label
rho_m_label = _ccllib.rho_m_label
rho_m_comoving_label = _ccllib.rho_m_comoving_label
rho_l_label = _ccllib.rho_l_label
rho_l_comoving_label = _ccllib.rho_l_comoving_label
rho_g_label = _ccllib.rho_g_label
rho_g_comoving_label = _ccllib.rho_g_comoving_label
rho_k_label = _ccllib.rho_k_label
rho_k_comoving_label = _ccllib.rho_k_comoving_label
rho_ur_label = _ccllib.rho_ur_label
rho_ur_comoving_label = _ccllib.rho_ur_comoving_label
rho_nu_label = _ccllib.rho_nu_label
rho_nu_comoving_label = _ccllib.rho_nu_comoving_label
...
def rho_x(*args):
  """rho_x(cosmology cosmo, double a, rho_x_label label, int status) -> double"""
  return _ccllib.rho_x(*args)

def omega_x(*args):
  """omega_x(cosmology cosmo, double a, omega_x_label label, int status) -> double"""
...
def specs_create_photoz_info(*args):
  """specs_create_photoz_info(void user_params, double user_pz_func) -> user_pz_info"""
