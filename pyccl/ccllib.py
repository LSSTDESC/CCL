...
def sigmaR(cosmo, R, a, status):
    """sigmaR(cosmology cosmo, double R, double a, int * status) -> double"""
    return _ccllib.sigmaR(cosmo, R, a, status)

def sigmaV(cosmo, R, a, status):
    """sigmaV(cosmology cosmo, double R, double a, int * status) -> double"""
    return _ccllib.sigmaV(cosmo, R, a, status)
...
def r_delta(cosmo, halomass, a, odelta, status):
    """r_delta(cosmology cosmo, double halomass, double a, double odelta, int * status) -> double"""
    return _ccllib.r_delta(cosmo, halomass, a, odelta, status)
...
def r_delta_vec(cosmo, a, odelta, halo_mass, output, status):
    """r_delta_vec(cosmology cosmo, double a, double odelta, double * halo_mass, double * output, int * status)"""
    return _ccllib.r_delta_vec(cosmo, a, odelta, halo_mass, output, status)
...
def halo_concentration_vec(cosmo, a, halo_mass, output, status):
    ...
    return _ccllib.halo_concentration_vec(cosmo, a, halo_mass, output, status)
