...
def rho_x(cosmo, a, label, status):
    """rho_x(cosmology cosmo, double a, ccl_rho_x_label label, int * status) -> double"""
    return _ccllib.rho_x(cosmo, a, label, status)
...
def rho_x_vec(cosmo, label, a, output, status):
    """rho_x_vec(cosmology cosmo, int label, double * a, double * output, int * status)"""
    return _ccllib.rho_x_vec(cosmo, label, a, output, status)
