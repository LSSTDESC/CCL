...
def omega_x(*args):
  """omega_x(cosmology cosmo, double a, species_x_label label, int status) -> double"""
...
def clt_fa_vec(*args):
  """
    clt_fa_vec(cosmology cosmo, CCL_ClTracer clt, int func_code, double aarr, 
        double output, int status)
    """
  return _ccllib.clt_fa_vec(*args)
