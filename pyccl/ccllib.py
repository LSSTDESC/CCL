...
def angular_l_inv2(cosmo, l, clt1, clt2, status):
    """angular_l_inv2(cosmology cosmo, int l, CCL_ClTracer clt1, CCL_ClTracer clt2, int * status) -> double"""
    return _ccllib.angular_l_inv2(cosmo, l, clt1, clt2, status)

def tracer_corr(cosmo, n_theta, theta, ct1, ct2, i_bessel, taper_cl, taper_cl_limits, corr_func):
    """tracer_corr(cosmology cosmo, int n_theta, double ** theta, CCL_ClTracer ct1, CCL_ClTracer ct2, int i_bessel, bool taper_cl, double * taper_cl_limits, double ** corr_func) -> int"""
    return _ccllib.tracer_corr(cosmo, n_theta, theta, ct1, ct2, i_bessel, taper_cl, taper_cl_limits, corr_func)

def tracer_corr_fftlog(cosmo, n_theta, theta, ct1, ct2, i_bessel, taper_cl, taper_cl_limits, corr_func, angular_cl):
    """tracer_corr_fftlog(cosmology cosmo, int n_theta, double ** theta, CCL_ClTracer ct1, CCL_ClTracer ct2, int i_bessel, bool taper_cl, double * taper_cl_limits, double ** corr_func, double (*)(ccl_cosmology *,int,CCL_ClTracer *,CCL_ClTracer *,int *) angular_cl) -> int"""
    return _ccllib.tracer_corr_fftlog(cosmo, n_theta, theta, ct1, ct2, i_bessel, taper_cl, taper_cl_limits, corr_func, angular_cl)

def tracer_corr_legendre(cosmo, n_theta, theta, ct1, ct2, i_bessel, taper_cl, taper_cl_limits, corr_func, angular_cl):
    """tracer_corr_legendre(cosmology cosmo, int n_theta, double ** theta, CCL_ClTracer ct1, CCL_ClTracer ct2, int i_bessel, bool taper_cl, double * taper_cl_limits, double ** corr_func, double (*)(ccl_cosmology *,int,CCL_ClTracer *,CCL_ClTracer *,int *) angular_cl) -> int"""
    return _ccllib.tracer_corr_legendre(cosmo, n_theta, theta, ct1, ct2, i_bessel, taper_cl, taper_cl_limits, corr_func, angular_cl)

def single_tracer_corr(theta_in, cosmo, ct1, ct2, i_bessel):
    """single_tracer_corr(double theta_in, cosmology cosmo, CCL_ClTracer ct1, CCL_ClTracer ct2, int i_bessel) -> double"""
    return _ccllib.single_tracer_corr(theta_in, cosmo, ct1, ct2, i_bessel)

def correlation_vec(cosmo, ct1, ct2, i_bessel, theta, output):
    """correlation_vec(cosmology cosmo, CCL_ClTracer ct1, CCL_ClTracer ct2, int i_bessel, double * theta, double * output)"""
    return _ccllib.correlation_vec(cosmo, ct1, ct2, i_bessel, theta, output)
...
L_MIN_INT = _ccllib.L_MIN_INT
L_MAX_INT = _ccllib.L_MAX_INT
NL = _ccllib.NL
