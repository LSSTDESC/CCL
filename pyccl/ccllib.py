...
def comoving_matter_density(*args):
  """comoving_matter_density(cosmology cosmo) -> double"""
  return _ccllib.comoving_matter_density(*args)
...
def sigmaRz(*args):
  """sigmaRz(cosmology cosmo, double R, double a, int * status) -> double"""
  return _ccllib.sigmaRz(*args)
...
def sigmaVz(*args):
  """sigmaVz(cosmology cosmo, double R, double a, int * status) -> double"""
  return _ccllib.sigmaVz(*args)
...
def r_delta(*args):
  """r_delta(cosmology cosmo, double halomass, double a, double odelta, int * status) -> double"""
  return _ccllib.r_delta(*args)
...
def r_delta_vec(*args):
  """r_delta_vec(cosmology cosmo, double a, double odelta, double * halo_mass, double * output, int * status)"""
  return _ccllib.r_delta_vec(*args)

def r_Lagrangian(*args):
  """
    ...
    """
  return _ccllib.r_Lagrangian(*args)
...
def p_2h(*args):
  ...
  return _ccllib.p_2h(*args)

def p_halomod(*args):
  """p_halomod(cosmology cosmo, double k, double a, int * status) -> double"""
  return _ccllib.p_halomod(*args)

def halo_concentration(*args):
