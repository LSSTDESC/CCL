...
def correlation_3d(cosmo, n_k, k, pk, n_r, r, xi, do_taper_pk, taper_pk_limits, status):
    """correlation_3d(cosmology cosmo, int n_k, double * k, double * pk, int n_r, double * r, double * xi, int do_taper_pk, double * taper_pk_limits, int * status)"""
    return _ccllib.correlation_3d(cosmo, n_k, k, pk, n_r, r, xi, do_taper_pk, taper_pk_limits, status)
...
def correlation_3d_vec(cosmo, nkarr, npkarr, nr, xi, status):
    """correlation_3d_vec(cosmology cosmo, int nkarr, int npkarr, int nr, double * xi, int * status)"""
    return _ccllib.correlation_3d_vec(cosmo, nkarr, npkarr, nr, xi, status)
