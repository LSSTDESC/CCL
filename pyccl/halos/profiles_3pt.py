...
class Profile3pt(object):
    ...
    def fourier_3pt(self, prof, cosmo, k, M, a,
                    prof2=None, prof3=None, mass_def=None):
        ...
        Args:
            ...
            prof3 (:class:`~pyccl.halos.profiles.HaloProfile`): same as
            `prof2`
        ...
        if prof3 is None:
            ...
            if not isinstance(prof3, HaloProfile):
                raise TypeError("prof3 must be of type "
                                "`HaloProfile` or `None`")
