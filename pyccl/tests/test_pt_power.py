...
def test_pt_no_ptc_update():
    pee1 = ccl.nl_pt.get_pt_pk2d(COSMO, ptc=PTC, tracer1=TRS['TI'])
    pee1_no_update = ccl.nl_pt.get_pt_pk2d(COSMO, ptc=PTC, tracer1=TRS['TI'],
                                           update_ptc=False)
    ...
    pee2_no_update = ccl.nl_pt.get_pt_pk2d(COSMO2, ptc=PTC, tracer1=TRS['TI'],
                                           update_ptc=False)
    pee2 = ccl.nl_pt.get_pt_pk2d(COSMO2, ptc=PTC, tracer1=TRS['TI'])
