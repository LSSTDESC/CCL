...
ccl_parameters parameters_create_nu(
                        ...
                        double norm_pk, double n_s, double T_CMB, double Omega_g, double T_ncdm,
                        ...
                        double* m_nu, int n_m, int* status)
{
    return ccl_parameters_create(
                        ...
                        w0, wa, h, norm_pk, n_s, T_CMB, Omega_g, T_ncdm, bcm_log10Mc,
                        ...
                        int n_m, int* status)
{
    ...
    return ccl_parameters_create(
                        Omega_c, Omega_b, Omega_k, Neff, m_nu, n_m,
                        w0, wa, h, norm_pk, n_s, T_CMB, Omega_g, T_ncdm,
