...
This software is a publicly released LSST DESC product which was developed within the LSST DESC using LSST DESC resources. We welcome requests to access the code for non-DESC use; if you wish to use the code outside DESC please contact the [developers](https://github.com/LSSTDESC/CCL/CCL-administrators).

The list of released versions of this package can be found [here](https://github.com/LSSTDESC/CCL/releases), with the master branch including the most recent (non-released) development.

Installation instructions can be found in `INSTALL.md` in this directory. Documentation for`CCL` can be found in `DOC.md` in this directory, in our [wiki](https://github.com/LSSTDESC/CCL/wiki), in the `CCL` [readthedocs page](https://readthedocs.org/projects/ccl/), and in the doxygen docs contained in the `doc` folder within the repository. There are also multiple examples in C, python and jupyter notebooks available in the `examples` folder.
