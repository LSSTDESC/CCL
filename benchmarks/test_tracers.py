...
def get_prediction(
    ells, chi_i, chi_f, alpha, beta, gamma, der_bessel, der_angles
):
    ...
    if der_bessel == -1:
        fl *= 1.0 / (ells + 0.5) ** 4
    if der_angles == 2:
        fl *= (ells + 2.0) * (ells + 1.0) * ells * (ells - 1)
    elif der_angles == 1:
        fl *= ((ells + 1.0) * ells) ** 2
...
@pytest.mark.parametrize(
    "alpha,beta,gamma,is_factorizable,"
    "w_transfer,mismatch,der_bessel,der_angles",
    # non-factorizable
    [
        (-2.0, -1.0, -1.0, False, True, False, 0, 0),
        (-2.0, 0.0, -1.0, False, True, False, 0, 0),
        (-2.0, -1.0, 0.0, False, True, False, 0, 0),
        (-2.0, 0.0, 0.0, False, True, False, 0, 0),
        (0.0, 0.0, 0.0, False, True, False, 0, 0),
        # factorizable transfer functions
        (-2.0, -1.0, -1.0, True, True, False, 0, 0),
        (-2.0, 0.0, -1.0, True, True, False, 0, 0),
        (-2.0, -1.0, 0.0, True, True, False, 0, 0),
        (-2.0, 0.0, 0.0, True, True, False, 0, 0),
        (0.0, 0.0, 0.0, True, True, False, 0, 0),
        # Unit transfer functions
        (-2.0, 0.0, 0.0, False, False, False, 0, 0),
        (0.0, 0.0, 0.0, False, False, False, 0, 0),
        # Mismatch in kernel-transfer coverage
        (-2.0, -1.0, 0.0, True, True, True, 0, 0),
        (-2.0, -1.0, 0.0, False, True, True, 0, 0),
        # non-zero der_bessel
        (-2.0, -1.0, -1.0, False, True, False, -1, 0),
        # non-zero der_angles
        (-2.0, -1.0, -1.0, False, True, False, 0, 1),
        (-2.0, -1.0, -1.0, False, True, False, 0, 2),
        (-2.0, -1.0, -1.0, False, True, False, -1, 2),
    ],
)
def test_tracers_analytic(
    set_up,
    alpha,
    beta,
    gamma,
    ...
    # Prediction
    clpred = get_prediction(
        larr, chii, chif, alpha, beta, gamma, der_bessel, der_angles
    )
