...
for i, cpar in enumerate(
    [cpar_model1, cpar_model2, cpar_model3, cpar_model5, cpar_model4]
):
    pcs = csm.PcsPar()
    pcs.background_set(
        cpar["om"],
...
np.savetxt(
    "../growth_allz_cosmomad_ccl1-5.txt",
    growth_factor.T,
    header="z, D(z) CCL1, D(z) CCL2, D(z) CCL3, D(z) CCL4, D(z) CCL5",
)
