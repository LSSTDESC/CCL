...
def test_hodcl():
    ...
    prf = ccl.halos.HaloProfileHOD(
        mass_def=mass_def,
        concentration=cm,
        log10Mmin_0=np.log10(10.0**log10Mcut / cosmo["h"]),
        siglnM_0=sigma_Ncen,
        log10M0_0=np.log10(10.0**log10Mcut / cosmo["h"]),
        log10M1_0=np.log10(10.0**log10M1 / cosmo["h"]),
        alpha_0=alp_Nsat,
        bg_0=rgs,
        bmax_0=rmax,
    )
    ...
    pk_hod = ccl.halos.halomod_Pk2D(
        cosmo, hmc, prf, prof_2pt=prf2pt, lk_arr=lk_arr, a_arr=a_arr
    )
    # C_ell
