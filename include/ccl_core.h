...
typedef struct ccl_parameters {
  ...
  int N_nu_mass; // Number of different species of massive neutrinos
...
ccl_cosmology * ccl_cosmology_create_with_params(
        double Omega_c, double Omega_b, double Omega_k, double N_nu_rel, int N_nu_mass, double* mnu, 
...
ccl_parameters ccl_parameters_create_flat_lcdm_nu(double Omega_c, double Omega_b, double h, double norm_pk, double n_s, double N_nu_rel, int N_nu_mass, double* mnu, int *status);
ccl_parameters ccl_parameters_create_flat_wcdm_nu(double Omega_c, double Omega_b, double w0, double h, double norm_pk, double n_s, double N_nu_rel, int N_nu_mass, double* mnu, int *status);
ccl_parameters ccl_parameters_create_flat_wacdm_nu(double Omega_c, double Omega_b, double w0,double wa, double h, double norm_pk, double n_s, double N_nu_rel, int N_nu_mass, double* mnu, int *status);
ccl_parameters ccl_parameters_create_lcdm_nu(double Omega_c, double Omega_b, double Omega_k, double h, double norm_pk, double n_s, double N_nu_rel, int N_nu_mass, double* mnu, int *status);
