...
if (("${CMAKE_C_COMPILER_ID}" MATCHES "^(Apple)?Clang$") AND NOT FORCE_OPENMP)
    # using Clang, disabling OpenMP support
    set(CLASS_OMPFLAG "#OMPFLAG   = -fopenmp")
else()
    set(CLASS_OMPFLAG "OMPFLAG   = -fopenmp")
    if(DEFINED ENV{CONDA_PREFIX})
        set(CLASS_OMPFLAG "${CLASS_OMPFLAG} -I$ENV{CONDA_PREFIX}/include")
        STRING(REPLACE "/" "\\/" CLASS_OMPFLAG "${CLASS_OMPFLAG}")
    endif()
endif()
