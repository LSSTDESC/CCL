...
\item Number counts angular correlation functions in the range $0.01 \deg < \theta < 5 \deg$, using 5 bins per decade.
\item Lensing shear angular correlation functions ($\xi_+$,$\xi_-$), similarly to the above.
\end{itemize}
