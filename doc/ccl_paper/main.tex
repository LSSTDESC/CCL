...
\begin{eqnarray}
  \log P(k<{\tt K\_MIN\_SPLINE},z) = \log P({\tt K\_MIN\_SPLINE},z) \nonumber\\
...
\caption{PLACEHOLDER FOR HALO MODEL BENCHMARK CAPTION.}
