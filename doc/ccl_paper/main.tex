...
{\color{blue} Background cosmology parameter definition. Expansion and distance functions. Growth function and growth rate.}
...
{\color{blue} Matter power spectrum and transfer function definition. Approximations. Cosmic emulator. Baryonic physics model.}
...
{\color{blue} Kernels. Correlation functions. Nuisance parameters and functions.}
...
{\color{blue} Mass function definitions. Discussion of precision of Tinker mass function fits.}
...
{\color{blue} Neutrino mass/density definition. Transfer function. Definitions of hierarchies etc.}
...
%-------------------------------------------------------------------------------
\section{Implementation of photometric redshifts}
...
{\color{blue} Initial conditions. Normalization. Units and sensitivity to physical constants (G, c etc).}
...
%-------------------------------------------------------------------------------
\subsection{Matter power spectrum}
{\color{blue} Interpolation strategy. Sensitivity to spline parameters and sampling in $k$. Settings that control speed vs. accuracy. }
...
{\color{blue} Which basis to work in. Approach to performing oscillatory integrals.}
...
%-------------------------------------------------------------------------------
\subsection{Halo mass function}
{\color{blue} Evaluation of derivatives. Interpolations for different values of $\Delta$. Precision of $\sigma(M)$ calculation.}
...
%-------------------------------------------------------------------------------
\subsection{Massive neutrinos}
{\color{blue} Approximations. Approach to performing integrals.}
...
{\color{blue} Why we chose the $10^{-4}$ level of accuracy. Accuracy summary statistic used in VARRIC.}

%-------------------------------------------------------------------------------
\subsection{Validation tests on fiducial parameter sets}
{\color{blue} Overview of the code comparison. How the codes used for comparison were selected. Validation plots for several observables.}
...
{\color{blue} `Fair' sampling of parameter space with Latin Hypercubes. Summary statistics used, and binning of power spectrum in $k$ and $z$. Precision settings used for CLASS. Estimates of run-time. Results. Range of validity.}


\section{Usage}
\todo{Some general guidelines here of where to find the library and availability of examples/docs. One paragraph is sufficient.}

%-------------------------------------------------------------------------------
\section{Outlook}
{\color{blue} Extended parameter spaces. Example use case (integration into LSS pipeline).}
