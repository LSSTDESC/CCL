...
These relations were fit to haloes measured in $N$-body simulations where haloes were taken to have a cosmology-dependent overdensity criteria that comes from the spherical-collapse model. We use the fitting-formula of \cite{Bryan1998}
\begin{equation}
...
In order to be consistent one \emph{must} use a value of $\Delta_\mathrm{v}$ and $c(M)$ that is consistent with the halo definition used for the halo mass function and bias.
\end{comment}
...
\begin{figure*}
\centering
\includegraphics[width=0.95\textwidth]{pkdev_v2_z00}
...
\begin{figure*}
\centering
\includegraphics[width=0.95\textwidth]{pkdev_v2_z20}
...
In Figure~\ref{fig:halo_model} we show the power spectrum computed by the \ccl halo model compared to that from \textsc{halofit} and to the linear matter spectrum.

\begin{figure}
\includegraphics[width=0.45\textwidth]{halo_model.png}
