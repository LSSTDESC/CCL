...
\end{align}
The Limber approximation works best for wide radial kernels and high $\ell$. The integration in Eq. (\ref{eq:limber}) is performed via \elisa{This needs an explanation o how the Cls are splined and then integrated. We need to explain splining notes and integration limits, and any integration that occurs within the kernels.}
