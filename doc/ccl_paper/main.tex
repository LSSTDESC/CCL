...
{\bf
The differences between the \ccl calculations and the benchmarks are primarily due to the   
method used to compute the transform of Eq.~\ref{eq:xi3d}. In \ccl we use {\tt FFTLog}, while the benchmarks use either 
a slower precice numerical integration or an exact analytic expression, and therefore 
