...
{\color{blue} Matter power spectrum and transfer function definition. Approximations.}
...
%-------------------------------------------------------------------------------
\subsection{Matter power spectrum}
{\color{blue} Interpolation strategy. Sensitivity to spline parameters and sampling in $k$. Settings that control speed vs. accuracy. Emulation (Cosmicemu).}
