...
The implementation of the BC model for the impact of baryons on the matter power spectrum, described in Section \ref{sec:matterps} is also analytical, and accurate to $10^{-13}$.
