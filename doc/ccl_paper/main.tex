...
\end{equation}
\elisa{Can we unify notation with the section on the halo model. For example, with Eq. (\ref{eq:virial_radius})?}
...
\elisa{Any more details on halo bias/halo model?}
