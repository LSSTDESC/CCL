...
\begin{sidewaystable*}[!htp]
  ...
  \begin{tabular}{ l|c c c c}
    ...
    $C_l$ CMB lensing &(\ref{eq:cls}),(\ref{eq:cmblens}) & CCL6 & $1 \leq l\leq 3000$& $10^{-3}$ \\
