...
\begin{sidewaystable*}[!htp]
  ...
  \begin{tabular}{ l|c c c c}
    ...
    \hline
    Comoving radial distance (low $z$), $\chi$ & (\ref{eq:comrdist}) & CCL1-5 & $0\leq z\leq 5$ &  $10^{-4}$\\
    Comoving radial distance (high $z$), $\chi$ & (\ref{eq:comrdist}) & CCL1-3 & $10\leq z\leq 10^3$ &  $10^{-4}$\\
    Growth (low $z$), $D$ & (\ref{eq:growth}) & CCL1-5 &  $0\leq z\leq 5 $ &  $10^{-4}$\\
    Growth (high $z$), $D$ & (\ref{eq:growth}) & CCL1-3 & $10\leq z\leq 10^3$ &  $10^{-4}$\\
