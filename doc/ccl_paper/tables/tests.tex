...
\begin{sidewaystable*}[!htp]
  ...
  \begin{tabular}{ l|c c c c c}
    ...
    $C_\ell$ clustering & (\ref{eq:cls}),(\ref{eq:transfer_nc})& CCL6 &$2 \leq \ell\leq 3000$ &  max$\{{\rm CV},10^{-3}\}$ & Fig. \ref{fig:cls_limber}\\
    $C_\ell$ weak lensing & (\ref{eq:cls}),(\ref{eq:transfer_lensing})& CCL6 &$2 \leq \ell\leq 3000$ &  max$\{{\rm CV},10^{-3}\}$ & Fig. \ref{fig:cls_limber}\\
    $C_\ell$ gxy-gxy lensing & (\ref{eq:cls}),(\ref{eq:transfer_nc}),(\ref{eq:transfer_lensing})& CCL6 &$2 \leq \ell\leq 3000$ &  max$\{{\rm CV},10^{-3}\}$ & Fig. \ref{fig:cls_limber}\\
    $C_\ell$ CMB lensing auto &(\ref{eq:cls}),(\ref{eq:cmblens}) & CCL6 & $2 \leq \ell\leq 3000$& max$\{{\rm CV},10^{-3}\}$ & Fig. \ref{fig:cls_cmblens}\\
    $C_\ell$ CMB lensing cross &(\ref{eq:cls}),(\ref{eq:transfer_nc}),(\ref{eq:transfer_lensing}),(\ref{eq:cmblens}) & CCL6 & $2 \leq \ell\leq 3000$& max$\{{\rm CV},10^{-3}\}$ & Fig. \ref{fig:cls_cmblens}\\
    $\xi_{\pm},\xi_{gg},\xi_{ggl}$ & (\ref{eq:xi22flat}),(\ref{eq:xi02flat}),(\ref{eq:xi00flat}) & CCL6 & $0.01< \theta/{\rm deg}< 5$&  $0.5\sigma_{\rm LSST}$ & Fig. \ref{fig:corrval}\\
