...
static void compare_cls(char *compare_type,struct cls_MG_data * data)
{
  int status=0;
  ...
  ccl_parameters params = ccl_parameters_create(data->Omega_c, data->Omega_b, data->Omega_k,
		                  ...
		                  data->n_s,-1,-1,-1,data->mu_0, data->sigma_0,-1,NULL,NULL, &status);
  ...
  // Open files containing benchmarks
  sprintf(fname,"tests/benchmark/MG_cls/run_b1b1%s_log_cl_dd_MG.txt",compare_type);
  fi_dd_11=fopen(fname,"r"); ASSERT_NOT_NULL(fi_dd_11);
  sprintf(fname,"tests/benchmark/MG_cls/run_b1b2%s_log_cl_dd_MG.txt",compare_type);
  fi_dd_12=fopen(fname,"r"); ASSERT_NOT_NULL(fi_dd_12);
  sprintf(fname,"tests/benchmark/MG_cls/run_b2b2%s_log_cl_dd_MG.txt",compare_type);
  fi_dd_22=fopen(fname,"r"); ASSERT_NOT_NULL(fi_dd_22);
  sprintf(fname,"tests/benchmark/MG_cls/run_b1b1%s_log_cl_ll_MG.txt",compare_type);
  fi_ll_11=fopen(fname,"r"); ASSERT_NOT_NULL(fi_ll_11);
  sprintf(fname,"tests/benchmark/MG_cls/run_b1b2%s_log_cl_ll_MG.txt",compare_type);
  fi_ll_12=fopen(fname,"r"); ASSERT_NOT_NULL(fi_ll_12);
  sprintf(fname,"tests/benchmark/MG_cls/run_b2b2%s_log_cl_ll_MG.txt",compare_type);
  ...
  // Scan in the benchmark values from file.
...
CTEST2(cls_MG,analytic_MG) {
  compare_cls("analytic",data);
}

CTEST2(cls_MG,histo_MG) {
