...
static void compare_emu_nu(int i_model,struct emu_nu_data * data)
{
  ...
  ccl_parameters params = ccl_parameters_create(
            data->Omega_c[i_model-1], data->Omega_b[i_model-1], 0.0, 
            data->N_nu_rel, data->N_nu_mass, data->mnu[i_model-1], 
            data->w_0[i_model-1], data->w_a[i_model-1], data->h[i_model-1], 
            data->sigma_8[i_model-1], data->n_s[i_model-1], 
