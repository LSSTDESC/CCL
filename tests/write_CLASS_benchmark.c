...
void write_Pk_CLASS(int i_model)
{
  ...
  ccl_parameters params = ccl_parameters_create(Omega_c[i_model-1],Omega_b[i_model-1],0.0,NREL, NMAS, MNU,w_0[i_model-1],w_a[i_model-1],h[i_model-1],sigma_8[i_model-1],n_s[i_model-1],-1,NULL,NULL, &status);
  params.Omega_g=0;
